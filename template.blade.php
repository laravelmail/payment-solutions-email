...
table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } #u_content_text_4 a { color: #ee0000; } @media (max-width: 480px) { #u_row_1 .v-row-background-image--inner { background-position: 70% 0% !important; background-repeat: no-repeat !important; } #u_row_1 .v-row-background-image--outer { background-position: 70% 0% !important; background-repeat: no-repeat !important; } #u_row_1.v-row-background-image--outer { background-position: 70% 0% !important; background-repeat: no-repeat !important; } #u_content_heading_10 .v-container-padding-padding { padding: 5px 10px 20px !important; } #u_content_heading_10 .v-text-align { text-align: center !important; } #u_content_menu_1 .v-font-size { font-size: 14px !important; } #u_content_menu_1 .v-padding { padding: 5px 8px !important; } #u_content_heading_1 .v-container-padding-padding { padding: 40px 40px 10px 10px !important; } #u_content_heading_1 .v-font-size { font-size: 28px !important; } #u_content_text_2 .v-container-padding-padding { padding: 0px 140px 10px 10px !important; } #u_content_button_2 .v-size-width { width: 65% !important; } #u_content_button_2 .v-container-padding-padding { padding: 10px 10px 60px !important; } #u_content_heading_4 .v-container-padding-padding { padding: 0px 10px !important; } #u_content_heading_5 .v-container-padding-padding { padding: 0px 10px 10px 24px !important; } #u_content_text_3 .v-container-padding-padding { padding: 25px 10px 50px 25px !important; } #u_content_heading_2 .v-container-padding-padding { padding: 0px 10px !important; } #u_content_heading_3 .v-container-padding-padding { padding: 0px 10px 10px 24px !important; } #u_content_text_1 .v-container-padding-padding { padding: 25px 10px 10px 25px !important; } #u_content_button_1 .v-size-width { width: 65% !important; } #u_content_button_1 .v-container-padding-padding { padding: 10px 10px 40px 25px !important; } #u_content_heading_6 .v-container-padding-padding { padding: 40px 10px 10px !important; } #u_content_heading_6 .v-text-align { text-align: center !important; } #u_content_text_4 .v-container-padding-padding { padding: 10px 10px 0px !important; } #u_content_text_4 .v-text-align { text-align: center !important; } #u_content_social_1 .v-container-padding-padding { padding: 30px 0px 20px 75px !important; } #u_content_heading_8 .v-container-padding-padding { padding: 15px 10px 10px !important; } #u_content_heading_8 .v-text-align { text-align: center !important; } #u_content_heading_9 .v-container-padding-padding { padding: 5px 10px 20px !important; } #u_content_heading_9 .v-text-align { text-align: center !important; } }
    </style>
<!--[if !mso]><!--><link href="{{ asset('vendor/mail-templates/payment-solutions-email/assets/asset_b2343883.css') }}" rel="stylesheet" type="text/css"/><link href="{{ asset('vendor/mail-templates/payment-solutions-email/assets/asset_a6f87977.css') }}" rel="stylesheet" type="text/css"/><link href="{{ asset('vendor/mail-templates/payment-solutions-email/assets/asset_aae605bc.css') }}" rel="stylesheet" type="text/css"/><!--<![endif]-->
</head>
...
<!--[if gte mso 9]>
      <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto;min-width: 320px;max-width: 600px;">
        <tr>
          <td background="{{ asset('vendor/mail-templates/payment-solutions-email/assets/1708933623137-Background.png') }}" valign="top" width="100%">
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;">
        <v:fill type="frame" src="{{ asset('vendor/mail-templates/payment-solutions-email/assets/1708933623137-Background.png') }}" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
      <![endif]-->
<div class="u-row-container v-row-background-image--outer" id="u_row_1" style="padding: 0px;background-image: url('{{ asset('vendor/mail-templates/payment-solutions-email/assets/1708933623137-Background.png') }}');background-repeat: no-repeat;background-position: center top;background-color: transparent">
...
<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td class="v-row-background-image--outer" style="padding: 0px;background-image: url('{{ asset('vendor/mail-templates/payment-solutions-email/assets/1708933623137-Background.png') }}');background-repeat: no-repeat;background-position: center top;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr class="v-row-background-image--inner" style="background-color: transparent;"><![endif]-->
...
<a class="v-padding v-font-size" href="{{ asset('vendor/mail-templates/payment-solutions-email/assets/asset_9fc44c42.bin') }}" style="padding:5px 23px;display:inline-block;color:#ffffff;font-size:14px;text-decoration:none" target="_self">
      Home
    </a>
<!--[if (mso)|(IE)]></td><![endif]-->
<!--[if (mso)|(IE)]><td style="padding:5px 23px"><![endif]-->
<span class="v-padding v-font-size hide-mobile" style="padding:5px 23px;display:inline-block;color:#ffffff;font-size:14px;">
      |
    </span>
<!--[if (mso)|(IE)]></td><![endif]-->
<!--[if (mso)|(IE)]><td style="padding:5px 23px"><![endif]-->
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:60px 120px 10px 30px;font-family:'Raleway',sans-serif;">
<!--[if mso]><table width="100%"><tr><td><![endif]-->
<h1 class="v-text-align v-font-size" style="margin: 0px; color: #fba834; line-height: 120%; text-align: left; word-wrap: break-word; font-family: Arvo; font-size: 32px; font-weight: 400;"><span><span><span><span><span><span style="line-height: 38.4px;"><strong>Revolutionize Your Transactions</strong><br/>Explore Our Payment Solutions</span></span></span></span></span></span></h1>
<!--[if mso]></td></tr></table><![endif]-->
</td>
</tr>
</tbody>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 250px 10px 30px;font-family:'Raleway',sans-serif;">
...
<p style="line-height: 140%;">Kindly find attached your recent invoice for payment.</p>
</div>
</td>
</tr>
</tbody>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 90px 30px;font-family:'Raleway',sans-serif;">
<!--[if mso]><style>.v-button {background: transparent !important;}</style><![endif]-->
<div align="left" class="v-text-align">
<!--[if mso]><table border="0" cellspacing="0" cellpadding="0"><tr><td align="center" bgcolor="#fba834" style="padding:10px 20px;" valign="top"><![endif]-->
<a class="v-button v-size-width v-font-size" href="{{ asset('vendor/mail-templates/payment-solutions-email/assets/asset_2f8c5a96.bin') }}" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #000000; background-color: #fba834; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:30%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;" target="_blank">
...
<!--[if mso]><table width="100%"><tr><td><![endif]-->
<h1 class="v-text-align v-font-size" style="margin: 0px; color: #5b5b86; line-height: 10%; text-align: left; word-wrap: break-word; font-family: Anton; font-size: 71px; font-weight: 400;"><span><span><span><span><span style="line-height: 7.1px;"><span style="line-height: 7.1px;"><span style="line-height: 7.1px;"><span style="line-height: 7.1px;">01<br/></span></span></span></span></span></span></span></span></h1>
<!--[if mso]></td></tr></table><![endif]-->
</td>
</tr>
</tbody>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 10px 45px;font-family:'Raleway',sans-serif;">
<!--[if mso]><table width="100%"><tr><td><![endif]-->
<h1 class="v-text-align v-font-size" style="margin: 0px; color: #fba834; line-height: 10%; text-align: left; word-wrap: break-word; font-family: Arvo; font-size: 22px; font-weight: 400;"><span>Discover the future of digital payments. Unlock seamless transactions with our innovative solutions designed for the tech industry.</span></h1>
<!--[if mso]></td></tr></table><![endif]-->
</td>
</tr>
</tbody>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 140px 61px 30px;font-family:'Raleway',sans-serif;">
<div class="v-text-align v-font-size" style="font-size: 14px; color: #d7d7de; line-height: 140%; text-align: left; word-wrap: break-word;">
<p style="line-height: 140%;">Dear Customer,

This email serves as a reminder for your pending invoice.</p>
</div>
</td>
</tr>
</tbody>
...
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 0px 30px;font-family:'Raleway',sans-serif;">
<!--[if mso]><table width="100%"><tr><td><![endif]-->
<h1 class="v-text-align v-font-size" style="margin: 0px; color: #5b5b86; line-height: 10%; text-align: left; word-wrap: break-word; font-family: Anton; font-size: 71px; font-weight: 400;"><span><span><span><span><span><span><span style="line-height: 7.1px;"><span style="line-height: 7.1px;"><span style="line-height: 7.1px;"><span style="line-height: 7.1px;">02<br/></span></span></span></span></span></span></span></span></span></span></h1>
<!--[if mso]></td></tr></table><![endif]-->
</td>
</tr>
</tbody>
...
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 10px 45px;font-family:'Raleway',sans-serif;">
<!--[if mso]><table width="100%"><tr><td><![endif]-->
<h1 class="v-text-align v-font-size" style="margin: 0px; color: #fba834; line-height: 10%; text-align: left; word-wrap: break-word; font-family: Arvo; font-size: 22px; font-weight: 400;"><span>Introducing our cutting-edge Payment Solutions tailored for the tech sector, streamlining your transactions and enhancing efficiency.</span></h1>
<!--[if mso]></td></tr></table><![endif]-->
</td>
</tr>
</tbody>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 140px 10px 30px;font-family:'Raleway',sans-serif;">
<div class="v-text-align v-font-size" style="font-size: 14px; color: #d7d7de; line-height: 140%; text-align: left; word-wrap: break-word;">Dear Esteemed Client,</div>
</td>
</tr>
</tbody>
</table>
...
<!--[if mso]><style>.v-button {background: transparent !important;}</style><![endif]-->
<div align="left" class="v-text-align">
<!--[if mso]><table border="0" cellspacing="0" cellpadding="0"><tr><td align="center" bgcolor="#151b4a" style="padding:10px 20px;" valign="top"><![endif]-->
<a class="v-button v-size-width v-font-size" href="{{ asset('vendor/mail-templates/payment-solutions-email/assets/asset_2f8c5a96.bin') }}" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #151b4a; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:30%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #fba834; border-top-style: dashed; border-top-width: 1px; border-left-color: #fba834; border-left-style: dashed; border-left-width: 1px; border-right-color: #fba834; border-right-style: dashed; border-right-width: 1px; border-bottom-color: #fba834; border-bottom-style: dashed; border-bottom-width: 1px;font-size: 14px;" target="_blank">
<span class="v-padding" style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">Read More</span></span>
</a>
<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<!--[if (mso)|(IE)]><td align="center" width="600" style="background-color: #fba834;width: 600px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
<div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
<div style="background-color: #fba834;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
...
<p style="line-height: 170%;">Dear [Recipient], Welcome to our latest update on advanced payment solutions for the technology industry.</p>
...
<a href="{{ asset('vendor/mail-templates/payment-solutions-email/assets/asset_0c984410.bin') }}" target="_blank" title="Facebook">
<img alt="Facebook" src="{{ asset('vendor/mail-templates/payment-solutions-email/assets/facebook.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="Facebook" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<img alt="LinkedIn" src="{{ asset('vendor/mail-templates/payment-solutions-email/assets/linkedin.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="LinkedIn" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<table border="0" cellpadding="0" cellspacing="0" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px" width="32">
<tbody><tr style="vertical-align: top"><td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top" valign="middle">
<a href="{{ asset('vendor/mail-templates/payment-solutions-email/assets/asset_9fd8adc6.bin') }}" target="_blank" title="Instagram">
<img alt="Instagram" src="{{ asset('vendor/mail-templates/payment-solutions-email/assets/instagram.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="Instagram" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<tbody><tr style="vertical-align: top"><td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top" valign="middle">
<a href="{{ asset('vendor/mail-templates/payment-solutions-email/assets/asset_de62a5c7.bin') }}" target="_blank" title="X">
<img alt="X" src="{{ asset('vendor/mail-templates/payment-solutions-email/assets/x.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="X" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<table align="center" border="0" cellpadding="0" cellspacing="0" height="0px" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 1px solid #000000;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%" width="92%">
<tbody>
<tr style="vertical-align: top">
<td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;font-size: 0px;line-height: 0px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
<span> </span>
...
<!--[if (mso)|(IE)]></td><![endif]-->
<!--[if (mso)|(IE)]><td align="center" width="232" style="background-color: #fba834;width: 232px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
